...
const contactItems = [
  { label:"WhatsApp", value:"+62 812-9450-0613", href:"https://wa.me/6281294500613?text=Hi%20Berlin%2C%20I%20found%20your%20portfolio%20and%20I'm%20interested%20to%20connect!", desc:"Ping me directly", color:"#34D399", border:"rgba(52,211,153,0.25)", bg:"rgba(52,211,153,0.06)",
  ...
  { label:"Email", value:"berlinsugiyanto23@gmail.com", href:"mailto:berlinsugiyanto23@gmail.com", desc:"Fastest way to reach me", color:"#FCD34D", border:"rgba(252,211,77,0.25)", bg:"rgba(252,211,77,0.06)",
  ...
  { label:"LinkedIn", value:"linkedin.com/in/berlinsugi", href:"https://linkedin.com/in/berlinsugi", desc:"Let's connect professionally", color:"#38BDF8", border:"rgba(56,189,248,0.25)", bg:"rgba(56,189,248,0.06)",
  ...
  return (
    <a href={item.href} target={item.href.startsWith("mailto")?undefined:"_blank"} rel="noreferrer"
      ...
      style={{
        ...
        boxShadow:hovered?`0 0 24px ${item.color}10`:"none",
      }}
    >
      <div style={{
        ...
        flexShrink:0,color:item.color,transition:"all 0.2s",
      }}>{item.icon}</div>
      ...
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{color:"var(--muted)",opacity:hovered?1:0,transform:hovered?"translateX(0)":"translateX(-6px)",transition:"all .2s",flexShrink:0}}>
    ...
    <section id="contact" ref={ref} style={{background:"var(--navy)",borderTop:"1px solid rgba(59,130,246,0.07)",paddingBottom:80}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1.1fr 1fr",gap:32,alignItems:"start"}} className="contact-grid">
        <div style={{display:"flex",flexDirection:"column",gap:10}}>
          <p style={{
            fontSize:15,color:"#6B84A8",lineHeight:1.9,marginBottom:18,maxWidth:420,
            fontFamily:"'Outfit',sans-serif",
            opacity:visible?1:0,transform:visible?"none":"translateY(10px)",
            transition:"opacity .6s ease .15s,transform .6s ease .15s",
          }}>
            Actively seeking <span style={{color:"var(--blue-3)",fontWeight:700}}>Junior Backend Developer</span> roles.<br/>
        ...
        <div style={{
          ...
          <div style={{position:"absolute",top:"-40%",right:"-20%",width:"60%",height:"60%",background:"radial-gradient(circle,rgba(29,78,216,0.1),transparent 65%)",pointerEvents:"none"}}/>
          ...
          <h3 style={{fontFamily:"'Bricolage Grotesque',sans-serif",fontSize:22,fontWeight:800,color:"var(--white)",marginBottom:10,lineHeight:1.25,letterSpacing:"-0.5px"}}>
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:6,marginBottom:24}}>
            {["Full-time","Contract","Remote","Hybrid"].map(t=>(
              <span key={t} style={{
                fontSize:11,color:"var(--cyan)",background:"rgba(6,182,212,0.07)",
                border:"1px solid rgba(6,182,212,0.2)",padding:"4px 12px",borderRadius:100,
      ...
      <div style={{marginTop:64,paddingTop:24,borderTop:"1px solid rgba(59,130,246,0.08)",fontSize:11.5,color:"var(--muted)",textAlign:"center",fontFamily:"'JetBrains Mono',monospace"}}>

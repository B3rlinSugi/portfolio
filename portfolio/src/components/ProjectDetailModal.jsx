      ...
      <div style={{
        ...
        <div style={{ padding: "16px 28px 24px", borderTop: `1px solid ${a}15`, display: "flex", gap: 10, flexWrap: "wrap", flexShrink: 0 }}>
          ...
          {project.postman ? (
            ...
            <div style={{ display: "inline-flex", flex: 1, minWidth: 140, alignItems: "center", justifyContent: "center", gap: 8, padding: "11px 20px", borderRadius: 10, background: "rgba(55,65,81,0.35)", border: "1px solid rgba(55,65,81,0.35)", color: "#94A3B8", fontSize: 13.5, fontWeight: 600, fontFamily: "'Outfit',sans-serif" }}>
              API Docs tidak tersedia
            </div>
          )}
          <button
            onClick={close}

    ...
    >
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
           <img src="/foto.jpg" alt="Berlin Sugiyanto" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center", filter: "contrast(1.05) brightness(0.9)" }} onError={e=>{e.target.style.display="none";e.target.nextSibling.style.display="flex";}} />
               ...
               boxShadow: "0 10px 30px rgba(0,0,0,0.5)"
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    ...
                    <div style={{ width: "36px", height: "36px", borderRadius: "50%", overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)", background: "#1E293B", flexShrink: 0 }}>
                        <img src="/foto.jpg" alt="Avatar" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    </div>
                    {/* Handle & Status */}
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "48px", width: "100%", marginTop: "80px" }}>
           ...
           >
              ...
              <p style={{ color: "#94A3B8", maxWidth: "520px", marginBottom: "40px", lineHeight: 1.8, fontWeight: 500, fontSize: "16px", fontFamily: "'Inter', sans-serif" }}>
                 <strong style={{ color: "#FFFFFF", fontWeight: 700, marginRight: "6px" }}>Backend Developer.</strong> {t.tagline}
              </p>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "16px", alignItems: "center" }}>
                  ...
                  <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                      <motion.a href={data.github} target="_blank" rel="noreferrer" 
                      ...
                      <motion.a href="#" target="_blank" rel="noreferrer" 
                      ...
                      <motion.a href={data.instagram} target="_blank" rel="noreferrer" 

...
/* ── Visitor Counter — pakai hits.seeyoufarm.com (tidak diblokir AdBlocker) ── */
function useVisitorCount() {
  const [count, setCount] = useState(null);
  useEffect(() => {
    fetch("https://hits.seeyoufarm.com/api/count/incr/badge.json?url=https%3A%2F%2Fberlinsugi.vercel.app&count_bg=%238B5CF6&title_bg=%23060E1E&title=visitors&edge_flat=true")
      .then(r => r.json())
      .then(d => setCount(d.today + d.total))
      .catch(() => {});
  }, []);
  return count;
}
